...
/// <summary>
/// An <c>xsd:date</c> value: a calendar day, with an optional timezone offset.
/// </summary>
/// <remarks>
/// <para>
/// XML Schema 1.1 Part 2 §3.3.9, on the seven-property model of §D.2.1.
...
/// </para>
/// </remarks>
public readonly struct XsdDate : IEquatable<XsdDate>
{
    private const DateTimeFields Fields = DateTimeFields.Date;
    ...
    public XsdDate(int year, int month, int day, int? timezoneOffset = null)
    {
        ...
        _value = new SevenProperties(
            Fields, year, month, day, 0, 0, default,
    ...
    public static bool TryParse(ReadOnlySpan<byte> utf8, out XsdDate value)
    {
        ...
        value = new XsdDate(in parsed);
        return ok;
    }

    /// <summary>The <c>char</c> form of <see cref="TryParse(ReadOnlySpan{byte}, out XsdDate)"/>.</summary>
    public static bool TryParse(ReadOnlySpan<char> text, out XsdDate value) =>
    ...
    /// <inheritdoc />
    public bool Equals(XsdDate other) => _value.Equals(other._value);

    /// <inheritdoc />
    public override bool Equals(object? obj) => obj is XsdDate other && Equals(other);
